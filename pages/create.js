...
export default function Create() {
  ...
  const [name, setName] = useState("My Content"); // Media name
  ...
  const [description, setDescription] = useState("Great Content"); // Media description
            ...
            <div className={styles.create__grid_left}>
              ...
              <div className={styles.create__upload}>
                ...
                <div>
                  ...
                  >
                    {loading ? "Minting..." : "Mint Content as NFT"}
                  </button>
                </div>
              </div>
            </div>
